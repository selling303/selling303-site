...
relatedPosts:
  ...
  - slug: "relist-home-littleton-after-expired-listing"
    ...
    tag: "Selling"
    description: "Step-by-step relist playbook for South Denver sellers — timing, price adjustment formula, marketing relaunch checklist."
    date: "April 10, 2026"
...
<nav aria-label="Table of contents" style="background: #f4f7f9; border-left: 4px solid #002a3a; padding: 1.25rem 1.5rem; margin-bottom: 2rem; border-radius: 0 8px 8px 0;">
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Median days in MLS by sale outcome — Highlands Ranch closed and expired listings, April 2026",
  "description": "Median days in MLS for Highlands Ranch single-family residential listings closed or expired in April 2026, bucketed by close-price-to-original-list-price ratio. Sold ≥100% of original (n=65, 3 days). Sold 95–99% (n=44, 21 days). Sold 90–94% (n=9, 70 days). Sold <90% (n=10, 164 days). Expired without selling (n=22, 87 days).",
  "temporalCoverage": "2026-04-01/2026-04-30",
  "spatialCoverage": {"@type": "Place", "name": "Highlands Ranch, Colorado", "containedInPlace": {"@type": "AdministrativeArea", "name": "Douglas County, Colorado"}},
  ...
  "isBasedOn": "REcolorado MLS Market Analysis Summary, residential listings closed/expired/withdrawn April 1–30, 2026, Highlands Ranch, deduplicated for IRES cross-listings",
  "variableMeasured": {"@type": "PropertyValue", "name": "Median days in MLS (DIM) by close-price-to-original-list ratio bucket", "unitText": "DAY"}
}
</script>
