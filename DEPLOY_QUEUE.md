...
- **2026-04-14** — New blog post: "Best Parks and Trails Near Littleton and Highlands Ranch" (`src/content/blog/best-parks-trails-littleton-highlands-ranch.md`). Day 19 of content calendar. Best Of category, Neighborhoods tag. TOFU lifestyle post. Inline branded SVG map with Chatfield, South Platte Park, Backcountry, High Line Canal, Mary Carter Greenway. Web-verified stats from HRCA, CPW, SSPRD, High Line Canal Conservancy.
- **2026-04-14** — New SVG asset: `src/assets/images/littleton-highlands-ranch-parks-trails-map.svg` (standalone backup of the inline blog map)
